...
<div class="alert alert-info" role="alert">
    Percentage sum of active metrics is 100%. This is the expected value.
</div>
@else
<div class="alert alert-warning" role="alert">
    Percentage sum of active metrics is {{ $percentage_sum }}%. Expected value is 100%.
</div>
@endif
<div class="row">
    <div class="col-12" style="margin-bottom: 20px;">
        <a class="btn btn-primary" href="{{ route('metrics.create') }}"><i class="fas fa-plus"></i> New Metric</a>
    </div>
</div>
<div class="row">
    <div class="col-12">
                        ...
                        <table id="myTable1" class="display-1 table table-condensed table-hover table-striped responsive" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="right">{{ $metric->percentage }}%</td>
                                    <td class="text-center">
                                        <a title="Edit" href="{{ route('metrics.edit', [$metric->slug()]) }}"><i class="fas fa-edit"></i></a>&nbsp;&nbsp;
                                        <a title="Trash" href="{{ route('metrics.disable', [$metric->slug()]) }}" onclick="return confirmDisable()"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                                    @endif
                                @endforeach
                        ...
                        <table id="myTable2" class="display-1 table table-condensed table-hover table-striped responsive" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="right">{{ $metric->percentage }}%</td>
                                    <td class="text-center">
                                        <a title="Restore" href="{{ route('metrics.enable', [$metric->slug()]) }}"><i class="fas fa-undo"></i></a>
                                    </td>
                                </tr>
                                    @endif
                                @endforeach
