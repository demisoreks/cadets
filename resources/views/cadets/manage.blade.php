...
<div class="row">
    <div class="col-12" style="margin-bottom: 20px;">
        ...
        <a class="btn btn-pink" data-toggle="modal" data-target="#modal4"><i class="fas fa-edit"></i> Edit Details</a>
        @if ($cadet->status == "Cadet")
        <a class="btn btn-dark-green" data-toggle="modal" data-target="#modal1">Exam Records</a>
